...
function showTooltip(flag: number) {
  switch (flag) {
    case 1:
...
function hideTooltip(flag: number) {
  switch (flag) {
    case 1:
...
<template>
  <div class="py-12 ">
    <div class="mx-auto container max-w-[228px] px-4 py-4 bg-white rounded relative">
      <p class="text-sm font-semibold leading-none text-gray-800">
        Tooltip Title
      </p>

      <p class=" text-xs leading-none text-gray-600 pt-2 pb-2">
      ...
      <div class="flex-col md:flex-row flex items-center md:justify-center">
          ...
          <div id="tooltip1" role="tooltip" class="z-20 -mt-20 w-64 absolute transition duration-150 ease-in-out left-0 ml-8 shadow-lg bg-white p-4 rounded">
            ...
            <div class="flex justify-between">
              ...
              <div class="flex items-center">
                ...
                <button class="focus:outline-none bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-5 py-1 text-xs">
                  Next
                </button>
              </div>
            </div>
        ...
        <div class="relative my-28 md:my-0 md:mx-64" @mouseover="showTooltip(2)" @mouseout="hideTooltip(2)">
          ...
          <div id="tooltip2" role="tooltip" class="z-20 -mt-20 w-64 absolute transition duration-150 ease-in-out left-0 ml-8 shadow-lg bg-indigo-700 p-4 rounded">
            ...
            <p class="text-xs leading-4 text-white pb-3">
              Reach out to more prospects at the right moment.
            </p>
            <div class="flex justify-between">
              <div class="flex items-center">
              ...
              <div class="flex items-center">
                ...
                <button class="bg-white transition duration-150 ease-in-out focus:outline-none hover:bg-gray-200 rounded text-indigo-700 px-5 py-1 text-xs">
                  Next
                </button>
              </div>
            </div>
        ...
        <div class="relative" @mouseover="showTooltip(3)" @mouseout="hideTooltip(3)">
          ...
          <div id="tooltip3" role="tooltip" class="z-20 -mt-20 w-64 absolute transition duration-150 ease-in-out left-0 ml-8 shadow-lg bg-gray-800 p-4 rounded">
            ...
            <div class="flex justify-between">
              ...
              <div class="flex items-center">
                <span class="text-xs text-white underline mr-2 cursor-pointer">Skip Tour</span>
                <button class="bg-white transition duration-150 ease-in-out focus:outline-none hover:bg-gray-200 rounded text-gray-600 px-5 py-1 text-xs">
                  Next
                </button>
              </div>
            </div>
